...
let typescanscanThis = 
    testCase "TypeScan should return a list of types (compiled)" <| fun _ -> 
...
let typescanInteractive = 
    testCase "TypeScan should return a list of types (interactive)" <| fun _ -> 
        XTypeScan.forgetDefinedTypes()
...
[<Tests>]
let typescanForget = 
    testCase "TypeScan should be able to forget defined types" <| fun _ -> 
        XTypeScan.forgetDefinedTypes()
